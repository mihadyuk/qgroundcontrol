...
enum MAV_FRAME
{
	...
	MAV_FRAME_GLOBAL_SCALED=5, /* Global coordinate frame, WGS84 coordinate system. First value / x: latitude, second value / y: longitude, third value / z: positive altitude over mean sea level (MSL). Lat / Lon are scaled * 1000 to avoid floating point accuracy limitations. | */
	MAV_FRAME_GLOBAL_RELATIVE_ALT_SCALED=6, /* Global coordinate frame, WGS84 coordinate system, relative altitude over ground with respect to the home position. First value / x: latitude, second value / y: longitude, third value / z: positive altitude with 0 being at the altitude of the home location. Lat / Lon are scaled * 1000 to avoid floating point accuracy limitations. | */
